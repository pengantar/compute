...
**What is a next-generation firewall?** It is an entirely modern and effective approach to network security that adds more security layers to the traditional firewall for advanced capabilities like intrusion prevention, application and user visibility, SSL inspection, and unknown threat detection.
...
<ol start="2">
 	<li>**Application Control and User Management**</li>
</ol>
